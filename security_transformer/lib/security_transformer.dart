...
class ReplacerVisitor extends SimpleAstVisitor {
  ...
  visitAdjacentStrings(AdjacentStrings node) {
    ...
    replaceNodeInAst(node, node.accept(visitor), parent: parent);
  }
...
class SecurityTransformer extends Transformer {
  ...
  apply(Transform transform) async {
    ...
    final replacerVisitor = new ReplacerVisitor();
    compilationUnit.accept(replacerVisitor);
